      ...
      <section>
        ...
        <div className='glass-card p-6'>
          <p className='text-white text-opacity-40 text-sm mb-5'>
            Cada medicamento en las recetas se identifica visualmente con un
            color único.
          </p>
  ...
  return (
    ...
    >
      <div className='flex items-start justify-between mb-4'>
        <div
          className={`w-10 h-10 rounded-xl ${colorMap[color]} bg-opacity-15 flex items-center justify-center ${colorMap[color].split(' ')[0]}`}
        >
          {icon}
        </div>
        {comingSoon && (
      ...
      <p
        className={`font-display font-bold text-3xl ${colorMap[color].split(' ')[0]} mb-1`}
      >
        {value}
      </p>
